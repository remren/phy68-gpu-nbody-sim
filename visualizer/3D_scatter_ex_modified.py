...
sp1 = gl.GLScatterPlotItem(pos=pos, size=size, color=color, pxMode=False, glOptions='opaque')
sp1.translate(5, 5, 0)
w.addItem(sp1)
...
sp2 = gl.GLScatterPlotItem(pos=pos, color=(1, 1, 1, 1), size=size, pxMode=True, glOptions='opaque')
phase = 0.
...
sp3 = gl.GLScatterPlotItem(pos=pos3, color=(1, 1, 1, .3), size=0.1, pxMode=False, glOptions='opaque')
...
QtCore.QTimer.singleShot(100, update)  # Force first update after short delay
t.start(50)
